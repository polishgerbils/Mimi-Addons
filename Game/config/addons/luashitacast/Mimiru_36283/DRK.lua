...
profile.OnLoad = function()
	...
	AshitaCore:GetChatManager():QueueCommand(-1, '/bind q /drk DT MDT');
	AshitaCore:GetChatManager():QueueCommand(-1, '/bind e /drk DT PDT');
...
--***************Zerg set ***********************	
    Zerg = { -- Total: 22% (Cap with Desperate BLows + SV Songs + Haste)
		Head = 'Ace\'s helm', --4%
		Ammo = 'Happy Egg',
        Neck = 'Peacock Amulet',
        Ear1 = 'Wyvern Earring', --5%
        Ear2 = 'Cassie Earring',
